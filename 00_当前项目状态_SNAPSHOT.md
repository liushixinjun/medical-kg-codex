...
## 当前阶段
心血管内科图谱处于“全库质量治理收尾 + 下一疾病批次准备”阶段。

## 最新完成
- `BATCH-CARD-RS-GAP-20260714-002` 已导入 Neo4j。
- 高血压推荐补齐 `supported_by_evidence` 主证据关系。
- STEMI 溶栓阻断推荐补齐阻断规则动作。
- 正式 CDSS 推荐缺核心链路：0。
- 合理口径全量 RecommendationStatement 缺核心链路：0。

## 当前核心问题
- 原始旧口径仍显示 2 条 RecommendationStatement 缺 guideline，但这 2 条是教材证据推荐，不应伪造 guideline。
- VTE 骨架存在历史段落污染线索，需独立治理。

## 下一步唯一建议动作
进入 VTE 历史骨架污染治理，或按疾病台账启动下一批次。若继续质量治理，优先处理 VTE。

...
8 月大版本升级后，当前正式 Schema 更新日志写在主文件 `专科知识图谱Schema标准.md` 顶部；重大升级同步写入根目录 `专科知识图谱大版本变更记录.md`。本目录继续作为历史归档和附录目录，不再替代主文件日志。

最近同步：

| 版本 | 变更时间 | 变更类型 | 涉及章节 | 说明 |
|---|---|---|---|---|
| V3.0 | 2026-08-14 23:22:35 | 样板数据标准路径补齐 | 更新日志、关系标准、质量闸门 | 记录 AMI 与心肌病样板泛化关系治理；明确鉴别诊断必须走“疾病 → 鉴别对象 → 鉴别规则/排除检查/排除检验 → 证据”路径 |
| V3.0 | 2026-08-14 22:25:00 | 8月大版本主标准 | 全文 | 发布 CDSS 落地稳定版，主文件只保留当前可执行标准 |

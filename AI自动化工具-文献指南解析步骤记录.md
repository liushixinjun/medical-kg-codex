...
3. 重复节点关系迁移到 canonical 后，重复节点保留打标；仅对关系度为 0 的孤儿节点做精确 `DELETE`，不使用 `DETACH DELETE`。
4. 空壳治疗方案若已有同名 canonical 且 canonical 有下游动作/证据，则迁移路径/规则引用后删除旧空壳。
...
- 关系迁移：入边 160，出边 228
- 清理零关系孤儿诊断标准：4 个
- 空壳治疗方案并入 canonical：1 个，迁移路径/规则关系 3 条
